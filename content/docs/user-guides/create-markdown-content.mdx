...
This is a sample page for scholarly content with historical context relating to the [Nez Percé](https://en.wikipedia.org/wiki/Nez_Perce), also known as the Nimíipuu.
```
...
- **Add** a `<Viewer />` component to the bottom of our Markdown file and reference a collection for label of _Date_ and value of _1905_ with the `iiifContent` property. The `iiifContent` property URI can be either a relative or absolute path.
