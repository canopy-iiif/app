...
And inline within your content, render the Map component with custon points.
...
<Map>
  <MapPoint
    ...
    lng="75.63737"
    title="Boondi / Bundi (1826–1830)"
    summar="A hand-colored aquatint from East India Company sketches, depicting Bundi in a mountain pass, with the palace on the slope and fortifications rising to the summit."
    referencedManifests={[
      "https://api.dc.library.northwestern.edu/api/v2/works/4bdb5a22-6c7f-498d-8e6e-e49ea9bc4778?as=iiif",
    ]}
  />
