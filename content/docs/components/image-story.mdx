...
Once you've created a story in the editor, click **Links** and copy the bookmark URL.

Note the identifier **3683j** in this bookmark: https://storiiies.cogapp.com/view/3683j/Embassy-of-Hyderbeck-to-Calcutta-1800. This identifier can be used to construct a Manifest URL—https://manifest.storiiies-editor.cogapp.com/v3/3683j—which can then be used as the `iiifContent` value.
