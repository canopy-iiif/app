...
Individuals of any technical skill level can easily create and export Storiiies manifests using the [Storiiies Editor](https://editor.storiiies.cogapp.com/), which provides a user-friendly interface for defining stories and contextual descriptions. Once created, simply pass the manifest URL to `<ImageStory>` to embed the interactive experience directly in your MDX content.
