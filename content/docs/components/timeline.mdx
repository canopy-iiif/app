...
<Timeline
  title="A commission lifecycle"
  description="Follow the work from patron letter to gallery opening."
  range={{start: "1880", end: "1892", granularity: "year"}}
  timelineKey={[
...
>
  <TimelinePoint
    date="1880"
    key="commission"
    title="Patron secured"
    summary="Agrees to fund a new atlas of the subcontinent."
  />
  <TimelinePoint
    date="1882"
    key="research"
    title="Survey camp"
    summary="Cartographers collect on-site sketches."
  />
  <TimelinePoint
    date="1887"
    key="studio"
    title="Studio proofs"
    summary="Engravers deliver the first colored sheets."
  />
</Timeline>
