...
<References id="https://api.dc.library.northwestern.edu/api/v2/works/4bdb5a22-6c7f-498d-8e6e-e49ea9bc4778?as=iiif" />
...
```mdx
<References className="border-t border-slate-200 pt-6" />
```
