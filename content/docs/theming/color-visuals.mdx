import { Callout, Box, Colors, Radius, Scaling, accentColors, grayColors } from '@canopy-iiif/app/docs-legacy-compat';


# Color & Visuals

Implementers of Canopy IIIF can configure the color scheme and visual elements of the site by modifying the `theme` property in the `canopy.yml` file. See [theme configuration options](/configuration#theme) for more information.
