...
<ButtonWrapper variant="interstitial" text="Start building with Canopy">
  <Button href="/docs/configuration" label="Configuration" />
  <Button href="/docs/components" label="Content" variant="secondary" />
  <Button href="/docs/guides" label="User guides" variant="secondary" />
</ButtonWrapper>
...
```yaml filename="collection.json" {3,7}
{
