...
- Run the version bump command and commit:
  - Commit updated `package.json` files plus the generated `content/docs/developers/releases/releases.json` + `releases.data.mjs` files (and any edits to `content/docs/developers/releases/index.mdx` if present).
