...
import {Callout} from "@canopy-iiif/app/ui/server";
...
Need a deeper reference? The source of truth for internationalization is documented at [content/docs/i18n](https://canopy-iiif.github.io/app/docs/i18n/).
